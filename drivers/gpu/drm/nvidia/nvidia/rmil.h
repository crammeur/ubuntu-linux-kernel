...
NV_STATUS  NV_API_CALL  rm_shutdown_gvi_device      (nvidia_stack_t *, nv_state_t *);
NV_STATUS  NV_API_CALL  rm_gvi_suspend              (nvidia_stack_t *, nv_state_t *);
NV_STATUS  NV_API_CALL  rm_gvi_resume               (nvidia_stack_t *, nv_state_t *);
